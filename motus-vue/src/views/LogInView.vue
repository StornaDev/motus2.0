    ...
    <form>
      ...
      <div class="switch">
        <span v-if="mode == 'login'"
          ...
          <span class="link_switch" @click="switchToCreateAcc">
            Créer un compte</span
          ></span
        >
        <span v-else>
          Vous avez déjà un compte ?
          <span class="link_switch" @click="switchToLogin">
            Connexion</span
          ></span
        >
      </div>
      ...
      <div v-if="mode == 'login'">
        <button
          class="btn"
          :class="{ subLoading: status == 'loading' }"
          type="submit"
          @click="sendAction"
        >
  ...
  methods: {
    ...
    sendAction: function () {
      ...
      if (this.mode == "login") {
        ...
        if (
          !(this.pseudo == "" && this.mdp == "" && this.email == "") &&
          this.mdp == this.confirm
        ) {
          self.createAccount();
        } else {
